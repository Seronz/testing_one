...
<div class="table-responsive small">
    ...
    <tr>
        ...
        <td>
            ...
            {{-- Route dibawah adalah aturan route ressource dari laravel anda dapat mengecek aturan di terminal dengan mengetik
            ...
            <form action="/dashboard/categories/{{$category->slug}}" method="post" class="d-inline">
              @method('delete')
              @csrf
              <button class="badge bg-danger border-0" onclick="return confirm('Delete Post')">
                <svg class="bi"><use xlink:href="#edit"/></svg>
              </button>
            </form>
        </td>
